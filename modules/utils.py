...
def draw_fps(avg_fps, combined_img):
    ...
    cv2.putText(combined_img, "FPS: " + str(avg_fps_str), (20, 90), cv2.FONT_HERSHEY_SIMPLEX, 3.5, (0, 255, 0),
                thickness=6)
...
def postprocess(preds, img, orig_img, names):
    ...
    for i, pred in enumerate(preds):
        ...
        results.append(Results(orig_img=orig_img, path='', names=names, boxes=pred))
